...
<html lang="en">
    ...
    <head>
    	<title>Curtis Thompson - Thailand Adventure: February Update</title>
    ...
    <body>
		...
		<div id="main-content">
    		<h1 id="small-header-box">Thailand Adventure: February Update</h1>
    		<div class="notes-text">
        		<div class="notes-details"><span class="author">Curtis Thompson</span><span class="date">Tuesday 28th February 2017</span><span class="topic">Personal</span></div>		
